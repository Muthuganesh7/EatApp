...
class CartViewModel extends BaseModel {
  ...
  CartViewModel({required this.eatApis});
  ...
  Future<bool> placeOrder(BuildContext context, String userId,String cartId, String paymentMood) async {
    setState(ViewState.BUSY);
    var result =
    await eatApis.placeOrder(context, userId,cartId,paymentMood);
    if (result != null && result.status == "success") {
      setState(ViewState.IDLE);
      return true;
    } else {
